...
var idlFactory = function (_a) {
    ...
    var Tokens = IDL.Record({ 'e8s': IDL.Nat64 });
    var Archive = IDL.Record({ 'canister_id': IDL.Principal });
    var Archives = IDL.Record({ 'archives': IDL.Vec(Archive) });
    ...
    var BlockRange = IDL.Record({ 'blocks': IDL.Vec(Block) });
    ...
    var TransferFee = IDL.Record({ 'transfer_fee': Tokens });
    return IDL.Service({
